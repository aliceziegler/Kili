...
sub <- "sep18/2018-09-08_ffs_pls_cv_onlyForest_alpha_all_RMSE/"
inpath_general <- "../data/"
...
stats_all_lst <- lapply(resp_vec, function(resp){
  ...
  ###mrg stats
  mrg <- (rbind(stats_res, stats_gam, stats_gam, stats_gam_res, stats_pls, stats_gam_cv))
...
myColors <- c("mediumslateblue", "blue2", "aquamarine3", "chocolate1", "firebrick1")
...
cbind(mrg_tbl$plotID, mrg_tbl$residSRbirds, mrg_tbl$residsum_birds_N1)
