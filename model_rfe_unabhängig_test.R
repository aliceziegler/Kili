...
########################################################################################
###resampling by group = Für jede Landnutzungsform einen Plot je durchlauf (zufällig rausnehmen) ######verändern
########################################################################################
...
for (i in c("resid_SRmammals", "resid_SRdungbeetles", "resid_SRspiders", "resid_SRmillipedes", "resid_SRotheraculeata", 
            "resid_SRotheraculeata", "resid_SRparasitoids", "resid_SRcollembola", "resid_SRothercoleoptera", 
            "resid_SRsyrphids", "resid_SRorthoptera", "resid_SRbats", "resid_SRants", "resid_SRbees", "resid_SRmoths", 
            "resid_SRbirds", "resid_SRsnails", "resid_SRanimals", "resid_SRrosids", "resid_SRasterids", "resid_SRmonocots", 
            "resid_SReudicots", "resid_SRlycopodiopsida", "resid_SRconifers", "resid_SRferns", "resid_SRmagnoliids", 
            "resid_SRallplants", "SRmammals", "SRdungbeetles", "SRspiders", "SRmillipedes", "SRotheraculeata", 
            "SRparasitoids", "SRcollembola", "SRothercoleoptera", "SRsyrphids", "SRorthoptera", "SRbats", "SRants", "SRbees", 
            "SRmoths", "SRbirds", "SRsnails", "SRanimals", "SRrosids", "SRasterids", "SRmonocots", "SReudicots", 
            "SRlycopodiopsida", "SRconifers", "SRferns", "SRmagnoliids", "SRallplants")){
  ########################################################################################
